...
class Post {
    ...
    public static function getPostById ($postId) {
        ...
        $sql = "
        SELECT id, title, content, DATE_FORMAT(`created_at`, '%d.%m.%Y %H:%i:%s') AS formated_date, status FROM posts WHERE id = :id";
    ...
    public static function view($id){
        ...
        $sql = "SELECT id, title, content, DATE_FORMAT(`created_at`, '%d.%m.%Y %H:%i:%s') AS formated_date, status FROM posts WHERE id = :id";
