...
$router->get('admin/pages', 'AdminPagesController@index');
$router->get('admin/pages/add', 'AdminPagesController@add');
$router->post('admin/pages/add', 'AdminPagesController@add');
$router->get('admin/pages/edit/{id}', 'AdminPagesController@edit');
$router->post('admin/pages/edit/{id}', 'AdminPagesController@edit');
$router->get('admin/pages/delete/{id}', 'AdminPagesController@delete');
$router->post('admin/pages/delete/{id}', 'AdminPagesController@delete');
...
$router->get('page/{slug}', 'PagesController@index');
